...
<%@ attribute name="searchNameTwo" type="java.lang.String" required="false" description="参数二"%>
<%@ attribute name="searchNameThree" type="java.lang.String" required="false" description="参数三"%>
<%@ attribute name="searchNameFour" type="java.lang.String" required="false" description="参数四"%>
...
function searchGrid${id}(){
	top.layer.open({
	    ...
	    yes: function(index, layero){
			 ...
			 if("${searchNameTwo}" != ''){$("#${searchNameTwo}").val(item.split('_item_')[2]);}
	    	 if("${searchNameThree}" != ''){$("#${searchNameThree}").val(item.split('_item_')[3]);}
	    	 if("${searchNameFour}" != ''){$("#${searchNameFour}").val(item.split('_item_')[4]);}
