...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="dkContractInstallCost" action="${ctx}/daikin/dkContractInstallCost/checkList" method="post" class="form-inline">
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="dkContractInstallCost">
			<tr>
				...
				<td>
					<a href="#" onclick="openDialog_check('审核安装付款', '${ctx}/daikin/dkContractInstallCost/detail?id=${dkContractInstallCost.id}&checkType=1','800px', '500px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 审核</a>
