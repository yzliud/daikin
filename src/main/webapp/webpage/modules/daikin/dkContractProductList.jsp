...
<body class="gray-bg">
	...
	<form:form id="searchForm" modelAttribute="dkContractProduct" action="${ctx}/daikin/dkContractProduct/" method="post" class="form-inline">
		...
		<div class="form-group">
			<span>合同：</span>
				<sys:gridselect url="${ctx}/daikin/dkContractProduct/selectdkContract" id="dkContract" name="dkContract"  value="${dkContractProduct.dkContract.id}"  title="选择合同" labelName="dkContract.name" 
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		<thead>
			<tr>
				...
				<th  class="sort-column name">商品</th>
