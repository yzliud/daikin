		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<sys:gridselect url="${ctx}/daikin/dkContractProduct/selectdkProduct" id="dkProduct" name="dkProduct.id"  value="${dkContractProduct.dkProduct.id}"  title="选择商品ID" labelName="dkProduct.name" 
				...
				<tr>
					...
					<td class="width-35">
						<sys:treeselect id="suser" name="suser.id" value="${dkContractProduct.suser.id}" labelName="suser.name" labelValue="${dkContractProduct.suser.name}"
