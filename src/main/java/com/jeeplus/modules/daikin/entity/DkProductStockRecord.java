...
public class DkProductStockRecord extends DataEntity<DkProductStockRecord> {
	...
	@ExcelField(title="商品名称(必填)", fieldType=DkProduct.class, value="dkProduct.name", align=2, sort=1)
	...
	@ExcelField(title="标识(入库-出库)(必填)", dictType="stock_flag", align=2, sort=2)
	...
	@ExcelField(title="数量(必填)", align=2, sort=3)
