...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="dkContractInstallCost" action="${ctx}/daikin/dkContractInstallCost/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<sys:gridselect url="${ctx}/daikin/dkContractInstallCost/selectdkContract" id="dkContract" name="dkContract.id"  value="${dkContractInstallCost.dkContract.id}"  title="选择合同ID" labelName="dkContract.name" 
					...
					<td class="width-35">
						<input id="payDate" name="payDate" type="text" maxlength="20" class="laydate-icon form-control layer-date required"
							value="<fmt:formatDate value="${dkContractInstallCost.payDate}" pattern="yyyy-MM-dd"/>"/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>费用：</label></td>
					<td class="width-35">
						<form:input path="payFee" htmlEscape="false"    class="form-control required number"/>
					</td>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>安装队：</label></td>
					<td class="width-35">
						<form:input path="installTeam" htmlEscape="false" maxlength="20"  minlength="1"   class="form-control required"/>
					</td>
				</tr>
				<tr>
