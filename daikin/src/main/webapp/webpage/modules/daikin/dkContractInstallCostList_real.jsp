...
<body class="gray-bg">
	...
	<div class="row">
	<div class="col-sm-12">
	<form:form id="searchForm" modelAttribute="dkContractInstallCost" action="${ctx}/daikin/dkContractInstallCost/realList" method="post" class="form-inline">
	...
	<div class="col-sm-12">
		<div class="pull-left">
	       		<table:exportExcel url="${ctx}/daikin/dkContractInstallCost/export"></table:exportExcel><!-- 导出按钮 -->
